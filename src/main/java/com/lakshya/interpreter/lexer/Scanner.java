...
import static com.lakshya.interpreter.lexer.TokenType.*;
...
public class Scanner {
    ...
    private void string() {
        ...
        // The string value without the quotes.
    ...
    private void scanToken() {
        ...
        switch (c) {
            ...
            case '=':
                ...
                break;
            case '<':
                addToken(match('=') ? LESS_THAN_EQUALS : LESS_THAN);
                break;
            case '>':
                addToken(match('=') ? GREATER_THAN_EQUALS : GREATER_THAN);
                break;
            case '/':
                if (match('/')) {
                    while (peek() != '\n' && !isAtEnd()) advance();
